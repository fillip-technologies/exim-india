export default function TitaniumDioxideFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
  ...
  const filterOptions = [
    ...
    { id: 'rutile', label: 'Rutile Grade' },
    { id: 'pharma-food', label: 'Pharma & Food Grade' },
    { id: 'anatase', label: 'Anatase Grade' },
  ]
          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                placeholder="Search titanium dioxide grades..."
            ...
            <span className="text-xs font-semibold text-slate-500 shrink-0 bg-white px-2.5 py-1.5 rounded-full border border-slate-200">
              {totalResults} {totalResults === 1 ? 'Grade' : 'Grades'}
            </span>
          </div>
