export default function PearlPigmentFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
  ...
  const filterOptions = [
    { id: 'all', label: 'All Pearl Pigments' },
    { id: 'gold', label: 'Gold & Copper' },
    { id: 'silver', label: 'Silver White' },
    { id: 'red', label: 'Amber Red' },
    { id: 'mica', label: 'Pure Mica (C.I. 77019)' },
  ]
          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                placeholder="Search pearl shades, C.I. numbers..."
            ...
            <span className="text-xs font-semibold text-slate-500 shrink-0 bg-white px-2.5 py-1.5 rounded-full border border-slate-200">
              {totalResults} {totalResults === 1 ? 'Pigment' : 'Pigments'}
            </span>
          </div>
