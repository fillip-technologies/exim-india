export default function FoodAdditiveFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
  ...
  const filterOptions = [
    { id: 'all', label: 'All Food Additives' },
    { id: 'acidulant', label: 'Acidulants (Citric Acid)' },
    { id: 'emulsifier', label: 'Emulsifiers (Soya Lecithin)' },
    { id: 'texturizer', label: 'Texturizers (Gelatin / Cornstarch)' },
    { id: 'sweetener', label: 'Sweeteners (Sucrose)' },
    { id: 'specialty', label: 'Specialty Botanicals (Saffron)' },
  ]
          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                placeholder="Search food additives..."
