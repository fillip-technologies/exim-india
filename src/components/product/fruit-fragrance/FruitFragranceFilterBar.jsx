export default function FruitFragranceFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
  ...
  const filterTabs = [
    { id: 'all', label: 'All Fragrances', count: 13 },
    { id: 'berries', label: 'Berry Accords', count: 3 },
    { id: 'gourmand', label: 'Gourmand & Warm', count: 5 },
    { id: 'orchard', label: 'Orchard & Citrus', count: 5 },
  ]
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
          <div className="relative w-full sm:w-64">
            <input
              ...
              placeholder="Search fragrance, code, notes..."
          ...
          <div className="text-xs font-semibold text-slate-500 whitespace-nowrap shrink-0">
            Showing <span className="text-slate-900 font-bold">{totalResults}</span> fragrances
          </div>
        </div>
      </div>
    </div>
