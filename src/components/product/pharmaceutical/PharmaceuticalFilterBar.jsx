...
const CATEGORY_TABS = [
  { id: 'all', label: 'All 16 Pharma Colours', dotColor: 'bg-emerald-700' },
  { id: 'soluble-dyes', label: 'Soluble Dyes (IP/BP/USP)', dotColor: 'bg-sky-600' },
  { id: 'coating-lakes', label: 'Tablet Coating Lakes', dotColor: 'bg-indigo-600' },
  { id: 'yellows-oranges', label: 'Yellows & Oranges', dotColor: 'bg-amber-500' },
  { id: 'reds-pinks', label: 'Reds & Pinks', dotColor: 'bg-rose-500' },
  { id: 'blues', label: 'Blues', dotColor: 'bg-blue-600' },
]

export default function PharmaceuticalFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto shrink-0 justify-between md:justify-end">
            ...
            >
              ...
              <input
                type="text"
                placeholder="Search pharma colours, IP/USP or C.I...."
                value={searchQuery}
