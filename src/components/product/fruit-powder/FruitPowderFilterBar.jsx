export default function FruitPowderFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
  ...
  const filterTabs = [
    { id: 'all', label: 'All Fruit Powders', count: 19 },
    { id: 'tropical', label: 'Tropical Exotic', count: 8 },
    { id: 'orchard', label: 'Orchard & Berries', count: 5 },
    { id: 'superfood', label: 'Superfoods & Citrus', count: 6 },
  ]
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
          <div className="relative w-full sm:w-64">
            <input
              ...
              placeholder="Search fruit, variety, use..."
