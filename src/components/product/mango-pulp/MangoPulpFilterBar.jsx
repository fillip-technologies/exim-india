export default function MangoPulpFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
  ...
  const filterOptions = [
    { id: 'all', label: 'All Mango Pulps' },
    { id: 'alphonso', label: 'Alphonso (Hapus)' },
    { id: 'totapuri', label: 'Totapuri Pulp' },
    { id: 'kesar', label: 'Kesar Mango Puree' },
  ]
          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                placeholder="Search mango varieties..."
            ...
            <span className="text-xs font-semibold text-slate-500 shrink-0 bg-white px-2.5 py-1.5 rounded-full border border-slate-200">
              {totalResults} {totalResults === 1 ? 'Variety' : 'Varieties'}
            </span>
          </div>
