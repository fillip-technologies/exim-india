...
const CATEGORY_TABS = [
  { id: 'all', label: 'All 19 Emulsion Flavours', dotColor: 'bg-emerald-700' },
  { id: 'citrus', label: 'Citrus & Cloudy', dotColor: 'bg-amber-500' },
  { id: 'fruity', label: 'Tropical & Orchard', dotColor: 'bg-orange-500' },
  { id: 'berries', label: 'Berries & Currants', dotColor: 'bg-rose-500' },
  { id: 'beverage-specialty', label: 'Specialty Beverage', dotColor: 'bg-purple-600' },
  { id: 'sweet-dairy', label: 'Sweet & Dairy', dotColor: 'bg-yellow-600' },
]

export default function EmulsionFlavourFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto shrink-0 justify-between md:justify-end">
            ...
            >
              ...
              <input
                type="text"
                placeholder="Search emulsion flavours..."
                value={searchQuery}
            ...
            <div className="hidden sm:block text-xs font-bold text-slate-500 whitespace-nowrap">
              Showing <span className="text-emerald-800 font-extrabold">{totalResults}</span> emulsions
            </div>
          </div>
