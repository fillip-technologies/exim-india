...
const CATEGORY_TABS = [
  { id: 'all', label: 'All 15 Cosmetic Colours', dotColor: 'bg-emerald-700' },
  { id: 'lake', label: 'Aluminum & Ca Lakes', dotColor: 'bg-rose-500' },
  { id: 'salts-toners', label: 'Pure Salts & Toners', dotColor: 'bg-red-700' },
  { id: 'reds-pinks', label: 'Reds, Pinks & Purples', dotColor: 'bg-pink-500' },
  { id: 'yellows-oranges', label: 'Yellows & Oranges', dotColor: 'bg-amber-500' },
  { id: 'blues', label: 'Blue Lakes', dotColor: 'bg-sky-600' },
]

export default function CosmeticFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto shrink-0 justify-between md:justify-end">
            ...
            >
              ...
              <input
                type="text"
                placeholder="Search cosmetic colours or C.I...."
                value={searchQuery}
