export default function DiscoDustFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
  ...
  const filterOptions = [
    { id: 'all', label: 'All Disco Dusts' },
    { id: 'metallic', label: 'Gold & Silver' },
    { id: 'warm', label: 'Warm Tones (Red/Pink/Orange/Yellow)' },
    { id: 'cool', label: 'Cool Tones (Blue/Green/Violet)' },
    { id: 'pearl', label: 'Ivory & Champagne' },
  ]
          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1 sm:w-64">
              ...
              <input
                ...
                placeholder="Search by color or shade..."
