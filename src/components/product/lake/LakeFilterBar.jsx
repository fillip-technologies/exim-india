...
const CATEGORY_TABS = [
  { id: 'all', label: 'All 12 Lake Colours', dotColor: 'bg-emerald-700' },
  { id: 'yellow', label: 'Yellows & Oranges', dotColor: 'bg-amber-500' },
  { id: 'red', label: 'Reds & Pinks', dotColor: 'bg-rose-500' },
  { id: 'blue', label: 'Blues', dotColor: 'bg-sky-600' },
  { id: 'brown-black', label: 'Browns & Blacks', dotColor: 'bg-stone-800' },
]

export default function LakeFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto shrink-0 justify-between md:justify-end">
            ...
            >
              ...
              <input
                type="text"
                placeholder="Search lake colours, E number or C.I...."
                value={searchQuery}
