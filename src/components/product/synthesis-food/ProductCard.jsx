  ...
  return (
    ...
    >
      ...
      <div className="relative w-full min-h-[220px] aspect-[4/3] sm:aspect-square rounded-xl overflow-hidden bg-white mb-2.5 select-none border border-slate-100">
        <img
          src={product.image}
          alt={`${product.name} (C.I. ${product.ciNo})`}
          className="w-full h-full object-contain p-2 group-hover:scale-105 transition-transform duration-500"
          loading="lazy"
        />

        {/* ============================================================== */}
        {/* EXACT HOVER OVERLAY (Matching User's Reference Screenshot)    */}
        {/* ============================================================== */}
        <div
        ...
        >
          ...
          {/* 4. White Button: View More (Navigates directly to dedicated page) */}
          <Link
            to={`/products/synthetic-food-colours/${product.id}`}
