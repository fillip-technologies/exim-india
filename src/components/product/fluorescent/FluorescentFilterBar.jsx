export default function FluorescentFilterBar({
  activeFilter,
  setActiveFilter,
  searchQuery,
  setSearchQuery,
  ...
  const filterTabs = [
    { id: 'all', label: 'All Fluorescent Colours', count: 7 },
    { id: 'warm', label: 'Warm Neon', count: 4 },
    { id: 'cool', label: 'Cool Radiance', count: 3 },
  ]
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
          <div className="relative w-full sm:w-64">
            <input
              ...
              placeholder="Search code, shade name..."
